...
function show_loop_toggles_window() {
    const doc = parent.document;
    if (doc.getElementById("loop-toggles-window")) return;

    const win = doc.createElement("div");
    win.id = "loop-toggles-window";
    win.style.position = "absolute";
    win.style.top = "250px";
    win.style.left = "10px";
    win.style.width = "260px";
    win.style.background = "rgba(34,34,34,0.85)";
    win.style.color = "#fff";
    win.style.border = "3px solid #888";
    ...
    stateDiv.style.fontSize = "16px";
    stateDiv.style.marginBottom = "8px";
    win.appendChild(stateDiv);
