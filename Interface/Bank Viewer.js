...
function render_items(floors) {
	...
	let html = `
	<div style="position:fixed; left:50%; top:8vh; transform:translateX(-50%); z-index:100; box-sizing:border-box; display:flex; flex-direction:column; border:5px solid gray; background:black; padding:10px; width:80vw; max-width:1200px; min-width:520px; min-height:300px; max-height:84vh;">
	...
	html += `<div style="flex:0 1 auto; overflow-y:auto; overflow-x:hidden;">`;
