...
let ATTACK_ONLY_TARGETEDDD = true; // Toggle: true = only attack monsters with a target
...
async function attack_loop() {
    ...
    game_log("Check 3");
    game_log("ATTACK_ONLY_TARGETED is", ATTACK_ONLY_TARGETEDDD);
    if (ATTACK_ONLY_TARGETEDDD) {
    game_log("Check 4");
